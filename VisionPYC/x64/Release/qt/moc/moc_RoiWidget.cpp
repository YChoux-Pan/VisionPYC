/****************************************************************************
** Meta object code from reading C++ file 'RoiWidget.h'
**
...
#include "../../../../src/Plugins/RoiWidget.h"
...
#error "The header file 'RoiWidget.h' doesn't include <QObject>."
...
static constexpr auto qt_meta_stringdata_CLASSRoiWidgetENDCLASS = QtMocHelpers::stringData(
    "RoiWidget"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSRoiWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSRoiWidgetENDCLASS_t qt_meta_stringdata_CLASSRoiWidgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 9)   // "RoiWidget"
    },
    "RoiWidget"
};
